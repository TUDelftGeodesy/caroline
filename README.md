...
The current documentation still partly pertains to v0.1.0. In v4.X, the continuous and ad hoc product generation is functional, but the database integration with docker-compose.yml is still missing. 
