...
search_parameters = ['depsi_directory', 'track', 'asc_dsc', 'depsi_post_mode', 'dp_dlat', 'dp_dlon', 'dp_drdx',
                     'dp_drdy', 'dp_proj', 'dp_ref_dheight', 'dp_posteriori_scale_factor', 'dp_pred_model',
                     'dp_plot_mode', 'dp_do_plots', 'dp_fontsize',
                     'dp_markersize', 'dp_do_print', 'dp_output_format', 'dp_az0', 'dp_azN', 'dp_r0', 'dp_rN',
                     'dp_result',
                     'dp_psc_selection', 'dp_do_remove_filtered', 'dp_which_sl_mask', 'dp_shift_to_mean',
                     'dp_new_ref_cn',
                     'dp_map_to_vert', 'dp_output', 'dp_defo_lim', 'dp_height_lim', 'dp_ens_coh_lim',
                     'dp_ens_coh_local_lim',
                     'dp_stc_lim', 'dp_defo_clim', 'dp_height_clim', 'dp_ens_coh_clim', 'dp_ens_coh_local_clim',
                     'dp_stc_clim',
                     'sensor', 'depsi_post_dir', 'geocoding_dir', 'rdnaptrans_dir']
