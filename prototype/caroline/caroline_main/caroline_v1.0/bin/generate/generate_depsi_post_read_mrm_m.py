...
base_stack = open(f"{caroline_dir}/caroline_v{version}/files/depsi_post/read_mrm.m")
...
for track in range(len(tracks)):
    main = stack.format(AoI_name=AoI_name, asc_dsc=asc_dsc[track], fill_track=f"{tracks[track]:0>3d}")

    fw = open(
        "{}/{}_{}_{}_t{:0>3d}/psi/read_mrm_{}_{}_{}_t{:0>3d}.m".format(
