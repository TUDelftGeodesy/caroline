...
search_parameters = ['coregistration_directory', 'track', 'asc_dsc', 'crop_directory']
...
for track in range(len(tracks)):	
    try:
        mkdir("{}/{}_s1_{}_t{:0>3d}".format(out_parameters['crop_directory'], AoI_name, asc_dsc[track],
                                            tracks[track]))
    except OSError:
        pass  # Directory already exists
    f = open("{}/{}_s1_{}_t{:0>3d}/link_directory.txt".format(out_parameters['crop_directory'], AoI_name,
