...
base_stack = open("/home/sanvandiepen/code/Caroline/Caroline_main/Caroline_v{}/files/depsi_post/depsi_post.sh".format(version))
...
for track in range(len(tracks)):
    ...
    fw = open("{}/{}_s1_{}_t{:0>3d}/psi/depsi_post.sh".format(out_parameters[0], AoI_name, asc_dsc[track], tracks[track]), 'w')
    fw.write(main)
    fw.close()
