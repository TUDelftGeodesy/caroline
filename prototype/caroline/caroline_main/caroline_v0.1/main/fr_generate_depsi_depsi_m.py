...
base_stack = open("/home/sanvandiepen/code/Caroline/Caroline_main/Caroline_v{}/files/depsi/psi/depsi.m".format(version))
...
for track in range(len(tracks)):
    ...
    main = stack.format(AoI_name=AoI_name, fill_track="{:0>3d}".format(tracks[track]), asc_dsc=asc_dsc[track])
