...
python3 ${caroline_dir}/caroline_v${version}/bin/utils/send_success_email.py ${param_file} ${cpath} | mailx -s "CAROLINE: ${sensor}/${tracks_csv}/${timestamps}/${AoI_name}" -v ${EMAILS}
