...
base_stack = open("/home/sanvandiepen/code/Caroline/Caroline_main/Caroline_v{}/files/depsi_post/read_mrm.sh".format(version))
...
for track in range(len(tracks)):
    ...
    fw = open("{}/{}_s1_{}_t{:0>3d}/psi/read_mrm.sh".format(out_parameters[0], AoI_name, asc_dsc[track], tracks[track]), 'w')
    fw.write(main)
    fw.close()
