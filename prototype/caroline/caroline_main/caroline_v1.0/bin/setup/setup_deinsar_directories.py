...
for track in range(len(tracks)):
    try:
        mkdir("{}/{}_{}_{}_t{:0>3d}".format(out_parameters['coregistration_directory'], AoI_name,
                                            out_parameters['sensor'].lower(), asc_dsc[track], tracks[track]))
    except OSError:
        pass  # Directory already exists

    try:
        mkdir("{}/{}_{}_{}_t{:0>3d}/process".format(out_parameters['coregistration_directory'], AoI_name,
